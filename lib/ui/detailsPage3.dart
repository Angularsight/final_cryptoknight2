...
class DetailsPage3 extends StatefulWidget {
  ...
  final int index;
  const DetailsPage3({Key? key,required this.index}) : super(key: key);
...
class _DetailsPage3State extends State<DetailsPage3> {
  ...
  Widget build(BuildContext context) {
    ...
    var coinData = coinProvider.allCoinsBollinger.items![widget.index];
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        children: [
                          buildBollingerRow("Bollinger Top", '${coinData.bollingerBandsUpper30min}SP'),
                          buildBollingerRow("Bollinger Bottom", '${coinData.bollingerBandsLower30min}BP'),
                          buildRow("Current Price", "Rs 550"),
                        ],
                      ),
                      Padding(

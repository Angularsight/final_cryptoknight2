...
class DetailsPageF extends StatefulWidget {
  final String coinName;
  final int index;
  final String coinPrice;
  const DetailsPageF({Key? key,required this.coinName,required this.index,required this.coinPrice}) : super(key: key);

  @override
  _DetailsPageFState createState() => _DetailsPageFState();
}

class _DetailsPageFState extends State<DetailsPageF> {
  @override
